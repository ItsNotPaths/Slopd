...
ACTIONS := [Action]Action_Info {
    ...
    .Outdent             = {"edit.outdent", TX, 0},
    .Comment_Toggle      = {"edit.comment", TX, 0},
    .Move_Doc_Start      = {"edit.doc_start", TX, 0},
    .Move_Doc_End        = {"edit.doc_end", TX, 0},
...
BIND_DEFAULTS := [?]Bind {
    ...
    {{glfw.KEY_TAB, MS}, .Outdent}, // a different verb from Tab, so Shift is written out
    {{glfw.KEY_SLASH, MC}, .Comment_Toggle},
    {{glfw.KEY_HOME, MC}, .Move_Doc_Start},
    {{glfw.KEY_END, MC}, .Move_Doc_End},
    // The page keys are the Ctrl+Up/Down jump under another finger; `jump_lines` sizes both.
    {{glfw.KEY_PAGE_UP, 0}, .Jump_Up},
    {{glfw.KEY_PAGE_DOWN, 0}, .Jump_Down},
