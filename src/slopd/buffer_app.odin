...
main_text_buffer :: proc(a: ^App) -> ^edit.Buffer {
...
buffer_enter :: proc(a: ^App, b: ^edit.Buffer) {
    d := &b.doc
...
@(private = "file")
enter_indent :: proc(a: ^App, b: ^edit.Buffer, pos: txt.Pos) -> string {
...
@(private = "file")
enter_opens_block :: proc(a: ^App, b: ^edit.Buffer, pos: txt.Pos) -> bool {
...
@(private = "file")
grow_indent :: proc(lead: string, ind: txt.Indent) -> string {
